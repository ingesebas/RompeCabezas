...
// ESTA FUNCION LA HICE EN PRIMERA INSTANCIA, PERO ME DI CUENTA QUE NO ERA REUTILIZABLE,
// PORQUE SI CAMBIA EL TAMAÑO DE LA MISMA YA NO VA A SERVIR.
...
//Funcion que verifica si el juego es completado
function chequearSiGano(){
...
function mostrarCartelGanador(){
  alert("Lo has logrado. Felicitaciones!!!");
}
...
function intercambiarPosiciones(fila1, columna1, fila2, columna2){
  ...
  //console.log(clonElemento1);
  var clonElemento2 = elementoPieza2.cloneNode(true);
  //console.log(clonElemento2);
